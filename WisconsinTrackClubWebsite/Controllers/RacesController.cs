...
namespace WisconsinTrackClubWebsite.Controllers
{
    public class RacesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "RaceName,Location,Date")] Race race)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "RaceId,RaceName,Location")] Race race)
        {
            if (ModelState.IsValid)
            {
